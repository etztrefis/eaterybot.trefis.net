                                            ...
                                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">
                                                        ...
                                                        <li>При создании нового состава внимательно заполняйте поле "Название" в соответсвии с таблицей <a href="/admin/products" className="text-purple-600 hover:text-purple-700">продуктов</a>.</li>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
