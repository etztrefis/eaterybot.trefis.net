...
import heroImg from "../../../assets/typing.png";
import "./HeaderComponent.css";

export default function HeaderComponent() {
	return (
		<section className="text-gray-600 body-font md:min-h-screen">
			<Fade bottom>
				<div className="container mx-auto flex px-5 py-14 md:flex-row flex-col items-center">
					<div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
						<img className="object-cover object-center rounded-2xl" draggable="false" alt="hero" src={heroImg} />
					</div>
